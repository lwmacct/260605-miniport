...
前端使用 hash 路由。页面级导航通过 path 表示，页面内部的二级 Tab 再使用 `?tab=` 参数：

```text
http://127.0.0.1:40237/#/
http://127.0.0.1:40237/#/services
http://127.0.0.1:40237/#/hosts
http://127.0.0.1:40237/#/dependencies
```
